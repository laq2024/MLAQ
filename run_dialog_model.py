...
# os.environ["ALL_PROXY"] = "socks5://127.0.0.1:7890/"
# OPENAI_KEY = str("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")
...
def main(args):
    if args.task in ['sort_dialog', 'sandwich_dialog']:
...
if __name__ == "__main__":
    # import openai
    # openai.api_key = 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

    parser = argparse.ArgumentParser()
    parser.add_argument("--data_dir", "-d", type=str, default="data")
    # parser.add_argument("--temperature", "-temp", type=float, default=0)
    parser.add_argument("--optimal_steps", "-ostep", type=int, default=10)
    parser.add_argument("--start_run_id", "-sri", type=int, default=2)
    parser.add_argument("--cycle_id", "-ci", type=int, default=0)
    parser.add_argument("--start_case_id", "-sci", type=int, default=8)
    parser.add_argument("--temperature", "-temp", type=float, default=0)
    ...
    parser.add_argument("--task", type=str, default="sandwich_dialog")
